    ...
    for (let i = 1; i <= 11; i++) {
        ...
        switch (i) {
            case 1:
                ...
                break;
            case 2:
                line.innerHTML = '<samp> a = input(\'Enter Amplitude of Sine wave: \');</samp>';
                break;
            case 3:
                line.innerHTML = '<samp>f = input(\'Enter Frequency of Sine wave (in Hz): \');</samp>';
                break;
            case 4:
...
function updateSineWork() {
    ...
    switch (code_row_no) {
        case 1:
            user_variable = 'a';
            enableInput('>> Enter Amplitude of Sine wave: ', 1, 5, 1, 2);
            break;
        case 2:
            user_variable = 'f';
            enableInput('>> Enter Frequency of Sine wave (in Hz): ', 10, 30, 1, 20);
            break;
        case 3:
            user_variable = 'N';
